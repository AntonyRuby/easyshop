...
class CheckoutHelper {
  static double calculateOriginalDeliveryCharge(
  ...
  static double calculateDeliveryCharge(
    ...
    if (orderType == 'take_away' ||
        ...
        (Get.find<AuthController>().isGuestLoggedIn() &&
            (Get.find<OrderController>().guestAddress == null &&
                Get.find<OrderController>().orderType != 'take_away'))) {
      deliveryCharge = 0;
    }
  ...
  static List<DropdownItem<int>> getDropdownAddressList(
  ...
  static bool checkZoneOfflinePaymentOnOff(
  ...
  static double calculateOrderAmount(
      {required double price,
      required double variations,
      required double discount,
      required double addOns,
  ...
  static double calculateParcelDeliveryCharge(
