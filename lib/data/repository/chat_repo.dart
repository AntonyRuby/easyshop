...
class ChatRepo {
  ...
  Future<Response> getMessages(
    ...
    return await apiClient.getData(
        '${AppConstants.messageListUri}?${conversationID != null ? 'conversation_id' : userType == AppConstants.admin ? 'admin_id' : userType == AppConstants.vendor ? 'vendor_id' : 'delivery_man_id'}=${conversationID ?? userID}&offset=$offset&limit=10');
  }
