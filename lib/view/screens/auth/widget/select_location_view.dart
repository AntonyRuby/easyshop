...
class _SelectLocationViewState extends State<SelectLocationView> {
          ...
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: ResponsiveHelper.isDesktop(context)
                  ? webView(authController, zoneList)
                  : Column(
                      ...
                      children: [
                          ...
                          Row(children: [
                            Expanded(
                                child: authController.moduleList != null
                                    ? const ModuleViewWidget()
                                    : const SizedBox()),
                            SizedBox(
                                width: authController.moduleList != null
                                    ? Dimensions.paddingSizeSmall
                                    : 0),
                            Expanded(
                                child: zoneSection(authController, zoneList)),
                          ]),
                          const SizedBox(
  ...
  Widget webView(
      AuthController authController, List<DropdownItem<int>> zoneList) {
    return Row(children: [
  ...
  Widget zoneSection(
      AuthController authController, List<DropdownItem<int>> zoneList) {
    return authController.zoneIds != null
        ? Container(
            ...
            child: CustomDropdown<int>(
              ...
              child: Padding(
                ...
                child: Text(authController.selectedZoneIndex == -1
                    ? 'select_zone'.tr
                    : authController
                        .zoneList![authController.selectedZoneIndex!].name
                        .toString()),
              ),
            ),
          )
  ...
  Widget mapView(AuthController authController) {
    return authController.zoneList!.isNotEmpty
        ? Center(
            child: Container(
              ...
              child: ClipRRect(
                ...
                child: Stack(clipBehavior: Clip.none, children: [
                  ...
                  Center(
                      child: Image.asset(Images.pickMarker,
                          height: 50, width: 50)),
                  Positioned(
                    top: 10,
                    left: 10,
