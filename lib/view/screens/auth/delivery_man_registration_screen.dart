      ...
      body: GetBuilder<AuthController>(builder: (authController) {
        ...
        return SafeArea(
            child: ResponsiveHelper.isDesktop(context)
                ? webView(authController, zoneList, dmTypeList, vehicleList,
                    identityTypeList)
                : Column(children: [
                    Padding(
                                                  ...
                                                  child: authController
                                                      ...
                                                      ? Container(
                                                          ...
                                                          child: CustomDropdown<
                                                            ...
                                                            items: zoneList,
                                                            child: Text(
                                                                '${authController.zoneList![0].name}'),
                                                          ),
                                                        )
                                                      : const Center(
                                                          child:
                                            ...
                                            authController.vehicleIds != null
                                                ? Container(
                                                    ...
                                                    child: CustomDropdown<int>(
                                                      ...
                                                      items: vehicleList,
                                                      child: Text(
                                                          '${authController.vehicles![0].type}'),
                                                    ),
                                                  )
                      ...
                      Container(
                        ...
                        child: Column(children: [
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: CustomDropdown<int>(
                                    ...
                                    items: typeList,
                                    child:
                                        Text('${authController.dmTypeList[0]}'),
                                  ),
                                ),
                              ],
                            )),
                          ...
                          Row(children: [
                            ...
                            Expanded(
                              child: CustomTextField(
                                titleText: authController.identityTypeIndex == 0
                                    ? 'identity_number'.tr
