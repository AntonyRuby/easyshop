      ...
      child: GetBuilder<LocationController>(builder: (locationController) {
        return GetBuilder<ParcelController>(builder: (parcelController) {
          List<DropdownItem<int>> senderAddressList =
              parcelController.getDropdownAddressList(
                  context: context,
          ...
          List<DropdownItem<int>> receiverAddressList =
              parcelController.getDropdownAddressList(
                  ...
                  addressList: locationController.addressList,
                  isSender: false);
          List<AddressModel> senderAddress = parcelController.getAddressList(
              addressList: locationController.addressList, isSender: true);
          List<AddressModel> receiverAddress = parcelController.getAddressList(
              addressList: locationController.addressList, isSender: false);
                              ...
                              onChange: (int? value, int index) {
                                if (parcelController.isSender) {
                                  ...
                                  streetController.text =
                                      senderAddress[index].streetNumber ?? '';
                                  ...
                                  streetController.text =
                                      receiverAddress[index].streetNumber ?? '';
                                  houseController.text =
