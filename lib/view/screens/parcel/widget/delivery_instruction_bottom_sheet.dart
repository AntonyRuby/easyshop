            ...
            ? SingleChildScrollView(
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Row(
                      ...
                      children: [
                        parcelController.parcelInstructionList!.isNotEmpty
                            ? Text("choose_delivery_instructions".tr,
                                style: robotoMedium)
                            : const SizedBox(),
                        InkWell(
                          onTap: () {
                  ...
                  parcelController.parcelInstructionList!.isNotEmpty
                      ? ListView.builder(
                          itemCount:
                              parcelController.parcelInstructionList!.length,
                          shrinkWrap: true,
                  ...
                  CustomButton(
                    onPressed:
                        (parcelController.instructionSelectedIndex != -1 ||
                                parcelController
                                    .customNoteController.text.isNotEmpty)
                            ? () {
...
class SelectedCardWidget extends StatelessWidget {
  ...
  const SelectedCardWidget(
      {super.key, required this.isSelect, required this.title});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: Theme.of(context).disabledColor.withOpacity(0.2)),
      ),
      child: Row(children: [
        Icon(isSelect ? Icons.check_circle : Icons.radio_button_off,
            color: isSelect
