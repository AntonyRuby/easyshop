...
import 'package:sixam_mart/view/screens/parcel/widget/parcel_app_bar.dart';
        ...
        return GetBuilder<BannerController>(builder: (bannerController) {
          bool showVideoAndServices = parcelController.videoContentDetails !=
              ...
              (parcelController.videoContentDetails!.bannerVideo != null ||
                  parcelController.videoContentDetails!.bannerImage != null);
                    ...
                    child: SizedBox(
                        ...
                        child: Column(
                            ...
                            children: [
                                      ...
                                      ? CarouselSlider.builder(
                                          ...
                                          itemBuilder:
                                            ...
                                            return ClipRRect(
                                              ...
                                              child: CustomImage(
                                                image:
                                                    '${bannerController.parcelOtherBannerModel!.promotionalBannerUrl}'
                                                    '/${bannerController.parcelOtherBannerModel!.banners![index].image}',
                                              ),
                                            );
                                          },
                                        )
                              ...
                              Text('what_deliver_everything'.tr,
                                      ...
                                      child: GridView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          return DeliverItemCard(
                                            image:
                                                '${parcelController.whyChooseDetails!.whyChooseUrl}'
                                                '/${parcelController.whyChooseDetails!.banners![index].image}',
                                            itemName: parcelController
                                                .whyChooseDetails!
                                                .banners![index]
                                                .title!,
                                                  ...
                                                  ? Expanded(
                                                      child: parcelController
                                                          ...
                                                          ? ClipRRect(
                                                              ...
                                                              child: CustomImage(
                                                                  image:
                                                                      '${parcelController.videoContentDetails!.promotionalBannerUrl}/${parcelController.videoContentDetails!.bannerImage}'),
                                                            )
                                                          : GetServiceVideo(
                                                              videoUrl: parcelController
                                                                      .videoContentDetails!
                                                                      .bannerVideo ??
                                                                  ''),
                                                    )
...
class ParcelShimmer extends StatelessWidget {
  ...
  const ParcelShimmer(
      {Key? key, required this.isEnabled, required this.isDeliveryItem})
      : super(key: key);
