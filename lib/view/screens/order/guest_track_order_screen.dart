...
import 'package:sixam_mart/view/screens/order/widget/guest_custom_stepper.dart';
import 'package:sixam_mart/view/screens/order/widget/traking_map_widget.dart';
...
class GuestTrackOrderScreen extends StatefulWidget {
  ...
  const GuestTrackOrderScreen(
      {Key? key, required this.orderId, required this.number})
      : super(key: key);
