...
class OfflineInfoEditDialog extends StatefulWidget {
  ...
  const OfflineInfoEditDialog(
      {Key? key, required this.offlinePayment, required this.orderId})
      : super(key: key);
...
class _OfflineInfoEditDialogState extends State<OfflineInfoEditDialog> {
  ...
  void initState() {
    ...
    for (int i = 0; i < widget.offlinePayment.input!.length; i++) {
      Get.find<OrderController>().informationControllerList.add(
              ...
              child: Column(children: [
                    ...
                    return Padding(
                      ...
                      child: CustomTextField(
                        titleText: widget.offlinePayment.input![i].userInput
                            ...
                            .replaceAll('_', ' '),
                        controller:
                            orderController.informationControllerList[i],
                        focusNode: orderController.informationFocusList[i],
                        nextFocus: i !=
                                orderController
                                        .informationControllerList.length -
                                    1
                            ? orderController.informationFocusList[i + 1]
                            : null,
                        inputAction: i !=
                                orderController
                                        .informationControllerList.length -
                ...
                Row(children: [
                  ...
                  CustomButton(
                    ...
                    onPressed: () {
                      for (int i = 0;
                          i < orderController.informationControllerList.length;
                          i++) {
                        if (orderController
