...
class WebCampaignView extends StatelessWidget {
  ...
  const WebCampaignView({Key? key, required this.campaignController})
      : super(key: key);
                        ...
                        return Row(children: [
                          Expanded(
                              child: index1 <
                                  ...
                                  ? campaignCart(
                                      context, index1, campaignController)
                                  : const SizedBox()),
                          ...
                          Expanded(
                              child: index2 <
                                      campaignController
                                          .itemCampaignList!.length
                                  ? campaignCart(
                                      context, index2, campaignController)
                                  : const SizedBox()),
                          const SizedBox(width: Dimensions.paddingSizeDefault),
                          Expanded(
                              child: index3 <
                                      campaignController
                                          .itemCampaignList!.length
                                  ? campaignCart(
                                      context, index3, campaignController)
                                  : const SizedBox()),
                          const SizedBox(width: Dimensions.paddingSizeDefault),
                          Expanded(
                              child: index4 <
                                      campaignController
                                          .itemCampaignList!.length
                                  ? campaignCart(
                                      context, index4, campaignController)
                                  : const SizedBox()),
                          const SizedBox(width: Dimensions.paddingSizeDefault),
                          Expanded(
                              child: index5 <
                                      campaignController
                                          .itemCampaignList!.length
                                  ? campaignCart(
                                      context, index5, campaignController)
                                  : const SizedBox()),
                        ]);
                      },
                    ),
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  PriceConverter.convertPrice(campaignController
...
class WebPopularItemShimmer extends StatelessWidget {
  final CampaignController campaignController;
  const WebPopularItemShimmer({Key? key, required this.campaignController})
      : super(key: key);
