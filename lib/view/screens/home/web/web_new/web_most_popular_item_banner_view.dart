...
class WebMostPopularItemBannerView extends StatelessWidget {
  ...
  const WebMostPopularItemBannerView(
      {Key? key, required this.campaignController})
      : super(key: key);
                      ...
                      children: [
                        PageView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            String? baseUrl1 = Get.find<SplashController>()
                                .configModel!
                                .baseUrls!
                                .campaignImageUrl;
                            ...
                            return Row(children: [
                              Expanded(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CustomImage(
                                    image:
                                        '$baseUrl1/${campaignController.basicCampaignList![index1].image}',
                                    fit: BoxFit.cover,
                                    height: 220,
                                  ),
                                ),
                                  ...
                                  child: hasSecond
                                      ? InkWell(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: CustomImage(
                                              image:
                                                  '$baseUrl2/${campaignController.basicCampaignList![index2].image}',
                                              fit: BoxFit.cover,
                                              height: 220,
                                            ),
                                          ),
...
class WebBannerShimmer extends StatelessWidget {
  final CampaignController campaignController;
  const WebBannerShimmer({Key? key, required this.campaignController})
      : super(key: key);
