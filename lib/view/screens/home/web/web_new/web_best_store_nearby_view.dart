  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius:
            BorderRadius.circular(isPharmacy ? 0 : Dimensions.radiusSmall),
      ),
      child: Column(children: [
        ...
        Stack(children: [
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                double distance = Get.find<LocationController>()
                                  ...
                                  LatLng(
                                      double.parse(storeList[index].latitude!),
                                      double.parse(
                                ...
                                return Padding(
                                  ...
                                  child: OnHover(
                                    isItem: true,
                                    child: isPharmacy
                                        ? StoreCard(store: storeList[index])
                                        : InkWell(
                                                                    ...
                                                                    children: [
                                                                      Row(
                                                                          children: [
                                                                            ...
                                                                            Text(PriceConverter.convertPrice(storeList[index].minimumOrder),
                                                                      ...
                                                                      Row(
                                                                          children: [
                                                                            Icon(Icons.star,
                                                                                ...
                                                                                color: Theme.of(context).primaryColor),
                                                                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                            Text(storeList[index].avgRating!.toStringAsFixed(1),
                                                                                style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                                                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                            Text("(${storeList[index].ratingCount.toString()})",
          ...
          if (showForwardButton)
            Positioned(
              top: 70,
              right: Get.find<LocalizationController>().isLtr ? 0 : 45,
              child: ArrowIconButton(
                onTap: () => scrollController.animateTo(
                    scrollController.offset + Dimensions.webMaxWidth,
                    duration: const Duration(milliseconds: 500),
...
class WebBestStoreNearbyShimmerView extends StatelessWidget {
  ...
  const WebBestStoreNearbyShimmerView({Key? key, required this.storeController})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      padding:
          EdgeInsets.only(left: isPharmacy ? 0 : Dimensions.paddingSizeDefault),
      itemCount: 8,
      itemBuilder: (context, index) {
        return Padding(
          padding: const EdgeInsets.only(
