  ...
  void initState() {
    ...
    if (!ResponsiveHelper.isWeb()) {
      Get.find<LocationController>().getZone(
          Get.find<LocationController>().getUserAddress()!.latitude, Get.find<LocationController>().getUserAddress()!.longitude, false,
                          ...
                          slivers: [
                            ...
                            SliverAppBar(
                              ...
                              title: Container(
                                ...
                                height: Get.find<LocalizationController>().isLtr ? 100 : 80,
                                          ...
                                          children: [
                                            (splashController.module != null && splashController.configModel!.module == null)
                                                ? InkWell(
                                                    ...
                                                    child: Image.asset(Images.moduleIcon, height: 25, width: 25, color: Colors.red),
                                                  )
                                                : const SizedBox(),
                                            SizedBox(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            boxShadow: [
                                              BoxShadow(
                                                  color: Colors.black.withOpacity(0.1), spreadRadius: 1, blurRadius: 5, offset: const Offset(2, 3))
                                            ],
                                          ),
                                          child: Row(children: [
                                            Icon(
