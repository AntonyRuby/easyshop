...
import 'package:sixam_mart/view/screens/home/web/web_new/middle_section_multiple_banner_view.dart';
...
import 'package:sixam_mart/view/screens/home/web/web_new/web_best_store_nearby_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_category_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_common_condition_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_coupon_banner_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_featured_categories_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_flash_sale_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_item_that_you_love_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_just_for_you_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_most_popular_item_banner_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_most_popular_item_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_new_on_mart_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_new_on_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_populer_store_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_recomanded_store_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_special_offer_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_promotional_banner_view.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_visit_again_view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:sixam_mart/view/screens/home/web/widgets/store_sorting_button.dart';
import 'package:sixam_mart/view/screens/home/web/web_new/web_new_banner_view.dart';
...
class WebNewHomeScreen extends StatefulWidget {
  ...
  const WebNewHomeScreen({Key? key, required this.scrollController})
      : super(key: key);
      ...
      Future.delayed(const Duration(seconds: 1), () {
        Get.dialog(const Center(
            child: SizedBox(
                height: 470,
                width: 550,
                child: AddressBottomSheet(fromDialog: true))));
      });
    }
  }
                  ...
                  child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              GetBuilder<StoreController>(
                                ...
                                return GetBuilder<FlashSaleController>(
                                  ...
                                  bool showRecommendedStore =
                                      storeController.recommendedStoreList !=
                                              null &&
                                          storeController
                                              .recommendedStoreList!.isNotEmpty;
                                  return Expanded(
                                    flex: 1,
                                    child: isFlashSaleActive
                                        ? const WebFlashSaleView()
                        ...
                        _isLogin
                            ...
                            : const SizedBox(),
                        isPharmacy
                            ? const WebBasicMedicineNearbyView()
                            : isShop
                                ? const WebMostPopularItemView(
                                    isShop: true, isFood: false)
                                : const WebSpecialOfferView(
                                    isFood: false, isShop: false),
                        (isPharmacy || isShop)
                            ? const MiddleSectionMultipleBannerView()
                            : isFood
                        ...
                        isPharmacy
                            ? const WebBestStoreNearbyView()
                            : isFood
                                ? const WebNewOnView(isFood: true)
                                : isShop
                        ...
                        isPharmacy
                            ? const SizedBox()
                            : isFood
                                ? const WebNewOnMartView()
                                : isShop
                                    ? const WebFeaturedCategoriesView()
                                    : const WebJustForYouView(),
                        (isPharmacy || isFood)
                            ? const SizedBox()
                            : isShop
