...
class CategoryItemScreenState extends State<CategoryItemScreen> {
  ...
  void initState() {
    ...
    Get.find<CategoryController>()
        .getSubCategoryList(widget.categoryID, widget.storeId);
                          ...
                          return InkWell(
                            onTap: () {
                              catController.setSubCategoryIndex(
                                  index, widget.categoryID, widget.storeId);
                              String? categoryId =
                                  catController.subCategoryIndex == 0
                                      ? widget.categoryID
                                      : catController
...
//           }
//           // Filter items by storeId
//           if (widget.storeId != null) {
//             item = item.where((i) => i.storeId == widget.storeId).toList();
//           }
//         }
...
//                               (Get.find<CategoryController>().pageSize! / 10)
//                                   .ceil()) {
//                             if (kDebugMode) {
//                               print('end of the page');
//                             }
...
//                           //     ? item
//                           //         .where((item) =>
//                           //             item.storeId == widget.store!.id &&
//                           //             item.selectedIndex == widget.selectedIndex)
//                           //         .toList()
//                           //     : [],
//                           stores: null,
...
// //                                           widget.categoryID, widget.storeId),
// //                                   child: Container(
// //                                     padding: const EdgeInsets.symmetric(
// //                                         horizontal: Dimensions.paddingSizeSmall,
// //                                         vertical:
...
// //                             } else {
// //                               if (catController.offset <
// //                                   (Get.find<CategoryController>().pageSize! /
// //                                           10)
// //                                       .ceil()) {
// //                                 if (kDebugMode) {
// //                                   print('end of the page');
...
// //                             //         widget.selectedIndex != null
// //                             //     ? item
// //                             //         .where((item) => widget.selectedStores!.any(
// //                             //             (store) => item.storeId == store.id))
// //                             //         .toList()
// //                             //     : [],
// //                             // items: item != null && widget.storeId != null
// //                             //     ? item
// //                             //         .where((i) => widget.storeId!
// //                             //             .contains(i.storeId.toString()))
// //                             //         .toList()
// //                             //     : [],
// //                             // items: item != null &&
// //                             //         widget.store != null &&
// //                             //         widget.selectedIndex != null
// //                             //     ? item
// //                             //         .where((item) => widget.selectedStores!
// //                             //             .any((store) => item.storeId == store.id))
// //                             //         .toList()
// //                             //     : [],
