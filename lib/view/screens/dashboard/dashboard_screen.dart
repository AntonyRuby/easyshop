        ...
        child: GetBuilder<OrderController>(builder: (orderController) {
          ...
          return Scaffold(
            ...
            body: ExpandableBottomSheet(
                                                    ...
                                                    onPressed: () {
                                                      if (isParcel) {
                                                        showModalBottomSheet(
                                                          ...
                                                          backgroundColor: Colors.transparent,
                                                          builder: (con) =>
                                                              ParcelBottomSheet(parcelCategoryList: Get.find<ParcelController>().parcelCategoryList),
                                                        );
                                                      } else {
              ...
              enableToggle: true,
              expandableContent:
                  (widget.fromSplash && Get.find<LocationController>().showLocationSuggestion && active && !ResponsiveHelper.isDesktop(context))
                      ? const SizedBox()
                      : (ResponsiveHelper.isDesktop(context) ||
                              !_isLogin ||
                              orderController.runningOrderModel == null ||
