...
class CartItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double? startingPrice =
        CartHelper.calculatePriceWithVariation(item: cart.item);
    double? endingPrice = CartHelper.calculatePriceWithVariation(
        item: cart.item, isStartingPrice: false);
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: CustomImage(
                          ...
                          height: ResponsiveHelper.isDesktop(context) ? 90 : 65,
