...
class RegistrationCard extends StatelessWidget {
  ...
  const RegistrationCard(
      {Key? key, required this.isStore, required this.splashController})
      : super(key: key);
              ...
              child: Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        isStore
                            ? splashController.landingModel!.joinSellerSubTitle!
                            : splashController
                      ...
                      CustomButton(
                        buttonText: isStore
                            ...
                            : splashController
                                .landingModel!.joinDeliveryManButtonName!,
                        ...
                        onPressed: () async {
                          String url = isStore
                              ? splashController
                                  .landingModel!.joinSellerButtonUrl!
                              : splashController
                                  .landingModel!.joinDeliveryManButtonUrl!;
