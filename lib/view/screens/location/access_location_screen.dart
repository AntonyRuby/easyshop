      ...
      onWillPop: () async {
        if (_canExit) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            ...
            backgroundColor: const Color(0xFFFE0100),
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: GetBuilder<LocationController>(builder: (locationController) {
            ...
            return (ResponsiveHelper.isDesktop(context) && locationController.getUserAddress() == null)
                ? WebLandingPage(
                        ...
                        child: FooterView(
                            child: SizedBox(
                                ...
                                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                  ...
                                  const SizedBox(height: Dimensions.paddingSizeLarge),
                                  Text('find_stores_and_items'.tr.toUpperCase(),
                                      textAlign: TextAlign.center, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                                  Padding(
