...
import 'package:sixam_mart/view/screens/store/widget/store_details_screen_shimmer_view.dart';
                                        ...
                                        children: [
                                          store.discount != null
                                              ? Container(
                                                  ...
                                                  padding: EdgeInsets.all(Dimensions.paddingSizeExtraSmall -
                                                      (GetPlatform.isAndroid ? (scrollingRate * Dimensions.paddingSizeExtraSmall) : 0)),
                                                  child: Text(
                                          ...
                                          Container(
                                            ...
                                            child: Align(
                                              ...
                                              child: Container(
                                                height: 100,
                                                color: Theme.of(context).cardColor.withOpacity(scrollingRate == 0.0 ? 1 : 0),
                                                padding: EdgeInsets.only(
                                                ...
                                                child: Row(children: [
                                                  ClipRRect(
                                                    ...
                                                    child: Stack(children: [
                                                      ...
                                                      storeController.isStoreOpenNow(store.active!, store.schedules)
                                                          ? const SizedBox()
                                                          : Positioned(
                                                              bottom: 0,
                                                              left: 0,
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              return Container(
                                                width: 225,
                                                padding:
                                                    const EdgeInsets.only(right: Dimensions.paddingSizeSmall, left: Dimensions.paddingSizeExtraSmall),
                                          ...
                                          children: [
                                                          ...
                                                          : InkWell(
                                                              ...
                                                              child: Container(
                                                                decoration: BoxDecoration(
                                                                    ...
                                                                    borderRadius: BorderRadius.circular(Dimensions.radiusSmall)),
                                                                padding:
                                                                    const EdgeInsets.symmetric(vertical: 3, horizontal: Dimensions.paddingSizeSmall),
                                                                ...
                                                                child: CustomCheckBox(
                                                                  ...
                                                                  onClick: () {
                                                                    if (storeController.isSearching) {
                                                                      ...
                                                                      storeController.getStoreItemList(storeController.store!.id, 1,
                                                                          Get.find<ItemController>().itemTypeList[index], true);
                                                                    }
                                                                  },
                                                                ),
                                                              ),
                                            ...
                                            PaginatedListView(
                                              ...
                                              totalSize: storeController.isSearching
                                                  ? storeController.storeSearchItemModel != null
                                                ...
                                                return Padding(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    padding: const EdgeInsets.only(
                                                        right: Dimensions.paddingSizeSmall, left: Dimensions.paddingSizeExtraSmall),
                                                    margin: const EdgeInsets.only(right: Dimensions.paddingSizeSmall),
                                                    child: ItemWidget(
                                                      isStore: false,
                                                      item: storeController.recommendedItemModel!.items![index],
