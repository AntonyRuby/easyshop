...
class WalletBottomSheet extends StatefulWidget {
  ...
  const WalletBottomSheet(
      {Key? key, required this.fromWallet, required this.amount})
      : super(key: key);
              ...
              GetBuilder<WalletController>(builder: (walletController) {
                return CustomButton(
                  width: ResponsiveHelper.isDesktop(context)
                      ...
                      : context.width / 3,
                  isBold: false,
                  buttonText: widget.fromWallet ? 'add_fund'.tr : 'convert'.tr,
                  ...
                  onPressed: () {
                    if (widget.fromWallet) {
                      ...
                      if (_amountController.text.isEmpty) {
                        ...
                        int? point = Get.find<UserController>()
                            .userInfoModel!
                            .loyaltyPoint;
                        ...
                        if (amount < minimumExchangePoint!) {
                          ...
                          walletController.pointToWallet(
                              amount, widget.fromWallet);
                        }
                      }
                    }
                  },
