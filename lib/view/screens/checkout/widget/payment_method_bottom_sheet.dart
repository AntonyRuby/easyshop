              ...
              child: GetBuilder<OrderController>(builder: (orderController) {
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                        height:
                            notHideCod ? Dimensions.paddingSizeExtraSmall : 0),
                    notHideCod
                        ? Text(
                        ...
                        : const SizedBox(),
                    SizedBox(
                        height: notHideCod ? Dimensions.paddingSizeLarge : 0),
                    Row(children: [
                              ...
                              bool isSelected =
                                  orderController.paymentMethodIndex == 2 &&
                                      Get.find<SplashController>()
                                              ...
                                              .getWay! ==
                                          orderController.digitalPaymentName;
                              return InkWell(
                                onTap: () {
                                  orderController.setPaymentMethod(2);
                                  orderController.changeDigitalPaymentName(
                                      Get.find<SplashController>()
                                          .configModel!
                                          .activePaymentMethodList![index]
                                          .getWay!);
