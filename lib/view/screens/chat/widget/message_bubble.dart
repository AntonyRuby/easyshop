...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool isReply = message.senderId !=
        Get.find<UserController>().userInfoModel!.userInfo!.id;

    return (isReply)
        ? Container(
            margin: const EdgeInsets.symmetric(
                horizontal: 0.0, vertical: Dimensions.paddingSizeDefault),
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: CustomImage(
                        ...
                        height: 40,
                        image:
                            '${userType == AppConstants.admin ? baseUrl!.businessLogoUrl : userType == AppConstants.vendor ? baseUrl!.storeImageUrl : baseUrl!.deliveryManImageUrl}/${user != null ? user!.image : ''}',
                      ),
                    ),
