...
class WebConversationListView extends StatefulWidget {
  ...
  @override
  State<WebConversationListView> createState() =>
      _WebConversationListViewState();
}
                                  ...
                                  child: CustomInkWell(
                                      ...
                                      if (Get.find<AuthController>()
                                        ...
                                        widget.chatController
                                          ...
                                          NotificationBody(
                                            ...
                                            notificationType:
                                                NotificationType.message,
                                            adminId: type == AppConstants.admin
                                                ? 0
                                                : null,
                                            restaurantId:
                                                type == AppConstants.vendor
                                    ...
                                    child: Stack(children: [
                                      ...
                                      GetBuilder<UserController>(
                                        ...
                                        return (userController.userInfoModel !=
                                                    null &&
