                                                ...
                                                onTap: () {
                                                  ...
                                                  widget.chatController
                                                    ...
                                                    NotificationBody(
                                                      ...
                                                      conversationId: 0,
                                                      image:
                                                          '${Get.find<SplashController>().configModel!.baseUrls!.businessLogoUrl}/${Get.find<SplashController>().configModel!.logo}',
                                                      name:
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: Column(children: [
                                    /// Header
                                    if (widget
                                            .chatController.notificationBody !=
                                        null)
                                      Container(
                                        padding: const EdgeInsets.symmetric(
                                            horizontal:
                                                            ...
                                                            itemBuilder:
                                                              ...
                                                              return MessageBubble(
                                                                ...
                                                                userType: widget
                                                                    ...
                                                                    ? AppConstants
                                                                        .admin
                                                                    : widget.chatController.notificationBody!.deliverymanId !=
                                                                            null
                                                                        ? AppConstants
                                                                            .deliveryMan
                                                                        : AppConstants
