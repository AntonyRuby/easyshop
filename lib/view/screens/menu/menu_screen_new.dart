                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      PortionWidget(icon: Images.orderSelect, title: 'orders'.tr, route: RouteHelper.getOrderRoute()),
                      //PortionWidget(icon: Images.favouriteSelect, title: 'favourite'.tr, route: RouteHelper.get),
                          ...
                          ? PortionWidget(
                              ...
                              suffix: !isLoggedIn
                                  ...
                                  : PriceConverter.convertPrice(
                                      userController.userInfoModel != null ? userController.userInfoModel!.walletBalance : 0),
                            )
                          : const SizedBox(),
                    ]),
                  )
                    ...
                    ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Padding(
                          ...
                          child: Text(
                            'earnings'.tr,
                            style:
                                robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor.withOpacity(0.5)),
                          ),
                        ),
                        Container(
                          decoration: BoxDecoration(
                          ...
                          child: Column(children: [
                            (Get.find<SplashController>().configModel!.refEarningStatus == 1)
                                ? PortionWidget(
                                    ...
                                    hideDivider:
                                        (Get.find<SplashController>().configModel!.toggleDmRegistration! && !ResponsiveHelper.isDesktop(context)) ||
                                                (Get.find<SplashController>().configModel!.toggleStoreRegistration! &&
